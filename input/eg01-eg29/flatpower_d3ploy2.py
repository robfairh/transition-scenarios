...
for calc_method in calc_methods:
    ...
    input_file = 'eg01-eg29-flatpower-d3ploy-buffer2' + buff_size + '-' \
        + calc_method + '.xml'
    output_file = 'eg01-eg29-flatpower-d3ploy-buffer2' + buff_size + '-' \
        + calc_method + '.sqlite'
