...
back steps used to predict supply and demand by running:
python flatpower_d3ployE2.py <buff_size> <back_steps>

for ex: to define a buffer of 2000 MW and 2 back steps
python flatpower_d3ployE2.py 2000 2
...
for calc_method in calc_methods:
    ...
    """%(calc_method, demand_eq, back_steps, buff_size, calc_method, back_steps)

for calc_method in calc_methods:

    input_file = 'eg01-eg23-flatpower-d3ploy-bufferB' + buff_size + '-' + back_steps + '-' + calc_method + '.xml'
    output_file = 'eg01-eg23-flatpower-d3ploy-bufferB' + buff_size + '-' + back_steps + '-' + calc_method + '.sqlite'
