...
for calc_method in calc_methods:
    ...
    input_file = 'eg01-eg23-flatpower-d3ploy-installed-bufferB'+ buff_size + '-' + calc_method + '.xml'
    output_file = 'eg01-eg23-flatpower-d3ploy-installed-bufferB'+ buff_size + '-' + calc_method + '.sqlite'
