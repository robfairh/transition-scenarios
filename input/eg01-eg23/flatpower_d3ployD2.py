...
for calc_method in calc_methods:
    ...
    input_file = 'eg01-eg23-flatpower-d3ploy-buffer' + buff_size + '-' + back_steps + '-' + calc_method + '.xml'
    output_file = 'eg01-eg23-flatpower-d3ploy-buffer' + buff_size + '-' + back_steps + '-' + calc_method + '.sqlite'
