...
python flatpower_d3ployE.py <buff_size>

for ex: to define a buffer of 2000 MW
python flatpower_d3ployE.py 2000
...
for calc_method in calc_methods:
    ...
    input_file = 'eg01-eg24-flatpower-d3ploy-bufferB' + buff_size + '-' + calc_method + '.xml'
    output_file = 'eg01-eg24-flatpower-d3ploy-bufferB' + buff_size + '-' + calc_method + '.sqlite'
