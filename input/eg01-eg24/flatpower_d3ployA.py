...
There is no buffer defined and the installed capacity feature is not used.
"""
...
for calc_method in calc_methods:
    ...
    input_file = 'eg01-eg24-flatpower-d3ploy-'+ calc_method +'.xml'
    output_file = 'eg01-eg24-flatpower-d3ploy-'+ calc_method +'.sqlite'
