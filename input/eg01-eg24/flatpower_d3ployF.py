...
python flatpower_d3ployF.py <buff_size>

for ex: to define a buffer of 2000 MW
python flatpower_d3ployF.py 2000
...
for calc_method in calc_methods:
    ...
    input_file = 'eg01-eg24-flatpower-d3ploy-installed-bufferB'+ buff_size + '-' + calc_method + '.xml'
    output_file = 'eg01-eg24-flatpower-d3ploy-installed-bufferB'+ buff_size + '-' + calc_method + '.sqlite'
